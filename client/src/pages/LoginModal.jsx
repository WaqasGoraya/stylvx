...
const LoginModal = ({ handleClose }) => {
  ...
  const handleGoogleLogin = async () => {
    window.open(`${import.meta.env.VITE_BASE_URL_SERVER}/auth/google`, "_self");
  };
  return (
    <>
      <div
      ...
      >
        <div
          className="modal-dialog modalCenter"
              ...
              <div className="row gx-3">
                ...
                <div className="col-sm-12 col-md-12 col-lg-6  modal-stylvix d-flex align-items-center justify-content-center">
                  <div className="modal-inner-div">
                    <h1 className="text-white modal-txt-stylvix text-center mb-2">
                      STYLVIX
                    </h1>
                ...
                <div className="col-sm-12 col-md-12 col-lg-6 modal-stylvix1 bg-white d-flex align-items-center justify-content-center">
                  <div className="text-center modal-div2-login">
                    ...
                    <div className="modal-login-div">
                      ...
                      <p>
                        <span className="text-dark fw-bold">Welcome!</span>{" "}
                        Create an account to start your shopping experience.
                      </p>
                      <form onSubmit={handleSubmit}>
                        <div className="form-group mb-3">
                          <div className="input-container-modal gap-0">
                            <i
                              className="fa fa-envelope input-icon"
                              aria-hidden="true"
                            ></i>
                            <input
                              type="email"
                        ...
                        <button
                          type="submit"
                          className="btn btn-primary mt-2 modal-btn-login"
                          disabled={loading}
                        >
                          Login
                        </button>
                    ...
                    <h6 className="txt-account-modal mb-4">
                      Don’t have an account?{" "}
                      <span>
                        <Link
                          to="/register"
                          className="txt-register-modal"
                          onClick={handleClose}
                        >
                          Register
                        </Link>
      ...
      {showForgotModal &&
        createPortal(
          <ForgotPasswordModal close={handleClose} />,
          document.body
        )}
    </>
  );
