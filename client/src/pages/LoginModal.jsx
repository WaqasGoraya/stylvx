                            ...
                            <div className="col-sm-12 col-md-12 col-lg-6 modal-stylvix1 bg-white d-flex align-items-center justify-content-center">
                                <div className="text-center modal-div2-login">
                                        ...
                                        <form>
                                            <div className="form-group mb-3">
                                                <div className="input-container-modal gap-0">
                                                    ...
                                                    <input type="email" className="form-control form-input-modal" required id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Address" />
                                                </div>
                                            </div>
                                            <div className="form-group mb-0">
                                                <div className="input-container-modal gap-0">
                                                    <i className="fa fa-lock" aria-hidden="true"></i>
                                                    <input type="password" className="form-control form-input-modal" required id="exampleInputPassword1" placeholder="Password" />
                                                </div>
                                            </div>
                                    ...
                                    <ul className='d-flex ul-modal-socialicon gap-3 p-0 mt-4'>
                                        <li><a href='#'><img src='./images/googleicon.png' alt="Google Icon"/></a></li>
                                        <li><a href='#'><img src='./images/facebookicon.png' alt="Facebook Icon"/></a></li>
                                    </ul>
                                    <h6 className='txt-account-modal mb-4'>Don’t have an account? <span><a href='/register' className='txt-register-modal'>Register</a></span></h6>
                                </div>
                            </div>
                        </div>
                    </div>
