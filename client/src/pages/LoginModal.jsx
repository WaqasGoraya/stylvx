...
function LoginModal({ show, handleClose }) {
    ...
    return (
        <div className="modal fade main-modal-div" id="exampleModal" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-bs-backdrop="true" style={{ display: 'block' }} >
        <div className="modal-dialog modalCenter">
          <div className="modal-content">
            <div className='mymodal-login' id="exampleModal">
              <div className="row">
                ...
                <div className="col-sm-12 col-md-12 col-lg-6 modal-stylvix1 bg-white d-flex align-items-center justify-content-center">
                  <div className="text-center modal-div2-login">
                    ...
                    <div className='modal-login-div'>
                      ...
                      <p><span className='text-dark fw-bold'>Welcome!</span> Create an account to start your shopping
                        experience.</p>
                      <form>
                        <div className="form-group mb-3">
                          <div className="input-container-modal gap-0">
                            <i className="fa fa-envelope input-icon" aria-hidden="true"></i>
                            <input type="email" className="form-control form-input-modal" required id="exampleInputEmail1"
                        ...
                        <div className="form-group mb-0">
                          <div className="input-container-modal gap-0">
                            ...
                            <input type="password" className="form-control form-input-modal" required id="exampleInputPassword1"
                        ...
                        <div className="form-group d-flex justify-content-between mt-1 txt-forgott-pass">
                          ...
                          <a href='#' className='txt-forgot-pass'>Forgot Password</a>
                        </div>
                        <button type="submit" className="btn btn-primary mt-2 modal-btn-login">Login</button>
                      </form>
                    </div>
                    ...
                    <ul className='d-flex ul-modal-socialicon gap-3 p-0 mt-4'>
                      <li><a href='#'><img src='./assets/images/googleicon.png'></img></a></li>
                      <li><a href='#'><img src='./assets/images/facebookicon.png'></img></a></li>
                      <li><a href='#'><img src='./assets/images/appleicon.png'></img></a></li>
                    </ul>
                    <h6 className='txt-account-modal mb-4'>Don’t have an account? <span><a href='signup.html' className='txt-register-modal'>Register</a></span></h6>
                  </div>
                </div>
              </div>
          </div>
